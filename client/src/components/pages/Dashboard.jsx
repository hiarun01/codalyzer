  ...
  return (
    <>
      ...
      <main className="bg-[#111010] min-h-screen flex flex-col items-center px-2 md:px-0 py-2 gap-5">
        {/* Result Section */}
        <section
          className="w-full mt-2 max-w-5xl flex-1 rounded-2xl bg-[#18181b] border border-[#232323] p-4 md:p-6 shadow-lg flex flex-col overflow-auto hide-scrollbar"
        ...
        {/* Input Section */}
        <section className="w-full max-w-5xl rounded-2xl border border-[#232323] bg-[#18181b] shadow-lg p-3 flex flex-col gap-5 sticky bottom-5">
          <textarea
          ...
          <div className="flex justify-center">
            <Button
              className="rounded-md bg-red-600 text-white cursor-pointer "
